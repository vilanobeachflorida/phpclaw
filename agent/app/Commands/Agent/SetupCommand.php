        ...
        return [
            ...
            'modules' => [
                'modules' => [
                    ...
                    'coding'      => ['enabled' => true, 'description' => 'Code generation and modification','role' => 'coding',          'provider_override' => null, 'model_override' => null, 'tools' => ['file_read', 'file_write', 'file_append', 'dir_list', 'mkdir', 'grep_search', 'shell_exec', 'git_ops', 'code_patch', 'diff_review'], 'cache_policy' => 'none', 'memory_policy' => 'full', 'timeout' => 180, 'retry' => 2, 'prompt_file' => 'modules/coding.md'],
                    ...
                    'browser'     => ['enabled' => true, 'description' => 'Web content fetching',           'role' => 'browser',          'provider_override' => null, 'model_override' => null, 'tools' => ['browser_fetch', 'browser_text', 'http_get', 'http_request'],                  'cache_policy' => 'standard',   'memory_policy' => 'summary_only', 'timeout' => 60,  'retry' => 1, 'prompt_file' => 'modules/browser.md'],
